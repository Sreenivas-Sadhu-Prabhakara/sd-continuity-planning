package com.bank.bian.continuityplanning.model;
...
/**
 * The BIAN control record for this service domain: "Continuity Plan Plan".
 *
 ...
 * to its asset type (Continuity Plan). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Continuity Plan Plan";
